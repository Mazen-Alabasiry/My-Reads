        ...
        <div className='content'>
            ...
            <h4 className='cat'>categories:<span> {book.categories.join(', ')}</span> </h4>
             <h4 className='date'>publish Date: <span> {book.publishedDate}</span></h4>
              <h4 className='link'>publish Date: <span  >{<a rel="noopener noreferrer" target='_blank' style={{color:'#ff0000d4' ,textDecoration:'none'}} href={book.infoLink}>Book Link </a>}</span></h4>  
